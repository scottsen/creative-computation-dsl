...
**Supersedes:** N/A
**Related:** ADR-002 (Cross-Domain Patterns), SPEC-CIRCUIT.md
...
- **DOMAIN_ARCHITECTURE.md:** Kairo domain vision
- **SPEC-OPERATOR-REGISTRY.md:** Operator metadata schema
- **SPEC-CIRCUIT.md:** Circuit domain specification (to be written)
