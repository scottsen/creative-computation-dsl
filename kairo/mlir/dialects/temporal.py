    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.flow.create", context=loc.context
            )
...
class FlowStepOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            # Add attributes
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.flow.step", context=loc.context
            )
...
class FlowRunOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            # Add attributes
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.flow.run", context=loc.context
            )
...
class StateCreateOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            # Add attributes
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.state.create", context=loc.context
            )
...
class StateUpdateOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            # Add attributes
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.state.update", context=loc.context
            )
...
class StateQueryOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            # Add attributes
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.temporal.state.query", context=loc.context
            )
...
class TemporalDialect:
    ...
    def is_temporal_op(op: Any) -> bool:
        ...
        return "kairo.temporal." in op_name
    ...
    def get_temporal_op_name(op: Any) -> Optional[str]:
        ...
        Returns:
            Operation name (e.g., "kairo.temporal.flow.run") or None
        """
        if not MLIR_AVAILABLE:
            return None
