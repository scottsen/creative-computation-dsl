    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.audio.buffer.create", context=loc.context
            )
...
class AudioOscillatorOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.audio.oscillator", context=loc.context
            )
...
class AudioEnvelopeOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.audio.envelope", context=loc.context
            )
...
class AudioFilterOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.audio.filter", context=loc.context
            )
...
class AudioMixOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.audio.mix", context=loc.context
            )
...
class AudioDialect:
    ...
    def get_audio_op_name(op: Any) -> Optional[str]:
        ...
        Returns:
            Operation name string (e.g., "kairo.audio.buffer.create") or None
        """
