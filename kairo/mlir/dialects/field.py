    ...
    def create(
        ...
        with loc, ip:
            ...
            attrs = {
                ...
                "op_name": ir.StringAttr.get("kairo.field.create", context=loc.context)
            }
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.field.gradient", context=loc.context
            )
...
class FieldLaplacianOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.field.laplacian", context=loc.context
            )
...
class FieldDiffuseOp:
    ...
    def create(
        ...
        with loc, ip:
            ...
            result.operation.attributes["op_name"] = ir.StringAttr.get(
                "kairo.field.diffuse", context=loc.context
            )
...
class FieldDialect:
    ...
    def get_field_op_name(op: Any) -> Optional[str]:
        ...
        Returns:
            Operation name (e.g., "kairo.field.gradient") or None
        """
        if not MLIR_AVAILABLE:
            return None
